            ...
            <div class="kontenside">
              ...
              <div class="">
                <div class="d-flex justify-content-start ms-4">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" href="dashboard.html" data-bs-toggle="modal" data-bs-target="#logoutModal">
                      <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <div class="d-flex align-items-center">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" style="background-color : #091527">
            <div class="container">
              <a class="navbar-brand text-light py-2 ms-3 fs-4"
                style="font-family: 'Poppins', sans-serif;">Dashboard</a>
            </div>
          </nav>
          <!-- Tutup Navbar -->
          ...
          <div class="card mt-4 shadow-lg" style="max-height: 550px;">
            <div class="card-body overflow-auto">
              <div class="container-fluid p-3">
                <div class="row">
                  <div class="col-4">
                    <div class="card shadow-lg" style="background-color : #091527">
                      <div class="card-body mb-5">
                        <div class="row">
                          <div class="col-8">
                            <div class="numbers">
                              <p class="text-sm mb-0 font-weight-bold text-light"
                                style="font-family: 'Lato', sans-serif;">
                                Jumlah Murid</p>
                              <h5 class="font-weight-bolder text-light" style="font-family: 'Poppins', sans-serif;">
                                400
                              </h5>
                            </div>
                          </div>
                          <div class="col-4 text-end">
                            <div class="icon icon-shape bg-light text-center rounded-circle ms-4" style="width: 50px">
                              <i class="bi bi-person-fill text-black fs-3"></i>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card shadow-lg" style="background-color : #091527">
                      <div class="card-body mb-5">
                        <div class="row">
                          <div class="col-8">
                            <div class="numbers">
                              <p class="text-md mb-0 font-weight-bold text-light"
                                style="font-family: 'Lato', sans-serif;">
                                Jumlah Mapel</p>
                              <h5 class="font-weight-bolder text-light" style="font-family: 'Poppins', sans-serif;">
                                15
                          ...
                          <div class="col-4 text-end">
                            <div class="icon icon-shape bg-light text-center rounded-circle ms-4" style="width: 50px">
                              <i class="bi bi-book-half fs-3"></i></i>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="d-flex">
                <div class="container-fluid">
                  <div class="row my-3">
                    <div class="col-10">
                      <h4 style="font-family: 'Poppins', sans-serif;">Jumlah murid tahun ini</h4>
                    </div>
                  </div>
                  <div class="row my-2">
                    <div class="col-10">
                      <div class="card ms-2" style="width: 1035px;">
                        <div class="card-body">
...
<script>
  ...
  var chartData = {
    ...
    datasets: [{
      data: [650, 800, 700, 850, 976, 1200, 1000],
